...
MANIFEST = os.path.join(BASE_DIR, "videos/07_generation_logs/vividface_test_manifest.csv")
LOG_FILE = os.path.join(BASE_DIR, "videos/07_generation_logs/vividface_test_log.txt")
